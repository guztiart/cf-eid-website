          ...
          <div className="row justify-content-between gy-4 mt-4">
            <div className="col-lg-8" data-aos="fade-up" data-aos-delay="100">
              <div className="portfolio-description">
                <h2>Floating Seal Product Details</h2>
                <p>
                  Our floating seals are designed to provide superior performance in demanding applications. 
                  These seals are engineered with precision to ensure optimal functionality and longevity.
                </p>
                <p>
                  With advanced materials and innovative design, our floating seals offer excellent resistance 
                  to wear, corrosion, and extreme temperatures. They are suitable for various industrial applications.
                </p>
            ...
            <div className="col-lg-4" data-aos="fade-up" data-aos-delay="200">
              <div className="portfolio-info">
                ...
                <ul>
                  <li><strong>Category</strong> <span>Floating Seals</span></li>
                  <li><strong>Model</strong> <span>FS-2024</span></li>
                  ...
                  <li><strong>Applications</strong> <span>Automotive, Marine, Industrial</span></li>
                </ul>
