  ...
  en: {
    ...
    productDetails: {
      ...
      evk2rv: {
        ...
        description2: "The EVK2RV is designed specifically for marine applications where water lubrication is preferred over traditional oil lubrication systems. This innovative seal solution provides superior performance in harsh marine environments while being environmentally friendly.",
      ...
      evr: {
        ...
        description1: "Excellent Durability and Vibration Absorption. Designed specifically for marine applications with water lubricated shafting systems.",
        description2: "The EVR bearing system provides superior performance in marine environments where water lubrication is preferred. This bearing solution offers excellent durability and vibration absorption characteristics.",
        description3: "Our water lubricated bearings are engineered with advanced materials that provide optimal performance in marine conditions. The design ensures smooth operation and extended service life.",
        ...
        applicationsValue: "Marine Propulsion Systems, Water Lubricated Shafts"
      },
      ...
      evu: {
        ...
        description1: "Poly-Urethane bearing developed for water lubricated stern tube systems based on our extensive water lubricated bearing technology and experience.",
        description2: "The EVU bearing utilizes advanced polyurethane materials specifically formulated for water lubrication applications. This innovative material provides excellent performance characteristics in marine environments.",
        description3: "With our extensive experience in water lubrication technology, the EVU bearing system offers superior durability and reliability. The polyurethane construction provides excellent wear resistance and long service life.",
        categoryValue: "Marine, Water Lubricated Bearings",
        typeValue: "Water Lubricated Stern Tube Bearing",
        modelValue: "EVU",
      ...
      rudderSeal: {
        ...
        description1: "Rudder seals with lip seals designed to prevent the leakage of lubricant and the ingress of seawater. They are approved by classification societies of each country. Their comprehensive lineup includes the standard CX type, the DX type with an additional standby seal, the pollution-free AX type, and the EVA type equipped with face seals.",
        description2: "As the Seto Inland Sea has long been a prosperous shipping area, we manufacture marine related products such as vulcanization molding of rubber for rudder sealing, intermediate bearings for propeller shafts, etc. Our rudder seals are engineered with precision to provide optimal performance in marine applications, ensuring maximum durability and efficiency in preventing oil leakage while maintaining smooth operation of the vessel's propulsion system.",
        description3: "Our rudder seals undergo rigorous quality control processes to meet international maritime standards. The specialized materials used in manufacturing offer excellent resistance to seawater corrosion and various lubricants, ensuring long service life even under extreme operating conditions in marine environments.",
        productInformation: "Product Information",
        category: "Category",
        sealedFluid: "Sealed fluid",
        operatingTemperature: "Operating Temperature",
  ...
  id: {
    ...
    productDetails: {
      ...
      rudderSeal: {
        title: "Rudder Seal",
        breadcrumb: "Rudder Seal",
        description1: "Segel kemudi dengan lip seal yang dirancang untuk mencegah kebocoran pelumas dan masuknya air laut. Mereka disetujui oleh masyarakat klasifikasi di setiap negara. Lini produk komprehensif mereka termasuk tipe standar CX, tipe DX dengan segel siaga tambahan, tipe AX bebas polusi, dan tipe EVA yang dilengkapi dengan face seal.",
        description2: "Karena Laut Dalam Seto telah lama menjadi area pelayaran yang makmur, kami memproduksi produk terkait maritim seperti vulkanisasi molding karet untuk segel kemudi, bantalan perantara untuk poros baling-baling, dll. Segel kemudi kami direkayasa dengan presisi untuk memberikan kinerja optimal dalam aplikasi maritim, memastikan daya tahan dan efisiensi maksimal dalam mencegah kebocoran oli sambil mempertahankan operasi yang halus dari sistem propulsi kapal.",
        description3: "Segel kemudi kami menjalani proses kontrol kualitas yang ketat untuk memenuhi standar maritim internasional. Material khusus yang digunakan dalam manufaktur menawarkan resistensi yang sangat baik terhadap korosi air laut dan berbagai pelumas, memastikan masa pakai yang panjang bahkan dalam kondisi operasional ekstrem di lingkungan maritim.",
        productInformation: "Informasi Produk",
        category: "Kategori",
        sealedFluid: "Cairan yang disegel",
        operatingTemperature: "Suhu Operasional",
        ...
        materialValue: "Kompon karet khusus untuk aplikasi maritim",
